...
function calculateSalesTax() {
	let taxRate = getSalesTaxRateForState(document.getElementById("state-tax").value);
	let subtotal = calculateSubtotal();
	console.log("taxRate: " + taxRate, "subtotal: " + subtotal);
	return roundMoney(taxRate * subtotal); // TODO calculateSalesTax
}
...
document.getElementById("btn-checkout").addEventListener("click",() => {
	alert("Your total is: $" + roundMoney(calculateSubtotal() + calculateSalesTax()).toFixed(2));
})
